...
@section('content')
    <main>
        <div class="container">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if ($clave->estado == 0)
                            <td>
                                <form action="{{ route('updateMetodoPago', ['id' => $clave->id,'value' => 1]) }}">
                                    <button type = "submit" class="btn btn-sm btn-success">Activar</button>
                                </form>
                            </td>
                            @else
                            <td>
                                <form action="{{ route('updateMetodoPago', ['id' => $clave->id,'value' => 0]) }}">
            ...
            <p>
                Mostrando {{$metodoPago->count()}} de {{ $metodoPago->total() }} concepto(s).
            </p>
        </div>
    </main>
@endsection
