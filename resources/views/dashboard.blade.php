...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-secondary">
        ...
        <b> Bienvenido &nbsp;{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}</b>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right bg-dark" aria-labelledby="navbarDropdownMenuLink">
                                <li class="hovermenu"><a class="nav-link"
                                    href="{{ route('conceptosInternos') }}">Conceptos SEA</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('claveProdServ') }}">ClaveProductoServicio</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('claveUnidad') }}">ClaveUnidad</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('formaPago') }}">FormaPago</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('metodoPago') }}">MetodoPago</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('tipoComprobante') }}">TipoComprobante</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('usoCfdi') }}">UsoCfdi</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('tipoRelacion') }}">TipoRelación</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('objetoImpuesto') }}">ObjetoImpuesto</a></li>
                                <li class="hovermenu"><a class="nav-link"
                                        href="{{ route('emisor') }}">Emisor</a></li>
                                <li class="hovermenu"><a class="nav-link"
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.1/bootstrap3-editable/js/bootstrap-editable.js">/**Editable*/
</script>
